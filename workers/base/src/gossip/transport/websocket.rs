...
use crate::gossip::resolver::DNSResolver;
use crate::gossip::transport::{ConnPool, GossipSink, GossipStream, Ws};
...
/// Validate that the `X-Sender-Host` header is valid for given certificate chain.
