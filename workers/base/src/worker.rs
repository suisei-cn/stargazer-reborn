...
use crate::change_events::db::db_events;
use crate::change_events::gossip::foca_events;
use crate::common::{Event, Worker, WorkerLogExt};
use crate::config::NodeConfig;
use crate::gossip::ident::ID;
use crate::gossip::resolver::StdResolver;
use crate::gossip::runtime::start_foca;
use crate::gossip::transport::ws_transport;
...
async fn worker_task(
    ...
    // Only IDs are stored in hash ring so we need to maintain an ID-to-Task mapping.
